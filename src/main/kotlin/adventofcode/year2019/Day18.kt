...
class Day18(test: Boolean) : PuzzleSolverAbstract(test) {
    ...
    override fun resultPartOne(): String {
        val maze = Maze18.from(inputLines)
        return maze.solve1().toString()
    }

    override fun resultPartTwo(): String {
        val maze = Maze18.from(inputLines("example_part2", "input_part2"))
        return maze.solve2().toString()
    }

}

class Maze18(maze: Map<Point, Char>) {
    ...
    companion object {
        fun from(inputLines: List<String>): Maze18 {
            return Maze18(inputLines
