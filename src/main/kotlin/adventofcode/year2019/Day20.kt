...
class Day20(test: Boolean) : PuzzleSolverAbstract(test) {
    ...
    private val maze = Maze20.from(inputLines)
...
class Maze20(
    ...
    companion object {
        fun from (inputLines: List<String>): Maze20 {
            ...
            return Maze20(passageMap, beamPortMap, entranceMap["AA"]!!.first(), entranceMap["ZZ"]!!.first())
        }
