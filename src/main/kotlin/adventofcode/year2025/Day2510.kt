...
import tool.mylambdas.collectioncombination.toPowerList
import kotlin.collections.joinToString
import kotlin.math.min

fun main() {
    Day2510(test=false).showResult()
}

class Day2510(test: Boolean) : PuzzleSolverAbstract(test, puzzleName="Factory", hasInputFile = true) {
...
class Machine(
    ...
    private fun determineAllLightPatternButtonCombinations(): Map<String, List<ButtonCombination>> {
        ...
        return buttonList
            .toPowerList()
            .map{ ButtonCombination(it.toSet()) }
