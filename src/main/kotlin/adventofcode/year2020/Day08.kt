...
class Day08(test: Boolean) : PuzzleSolverAbstract(test) {
    private val program = ProgramDay08(inputLines)
...
class ProgramDay08(inputLines: List<String>) {
    var accumulator = 0L
        private set
    val actionList = inputLines.map { ActionDay08(it) }
...
class ActionDay08(inputLine: String) {
