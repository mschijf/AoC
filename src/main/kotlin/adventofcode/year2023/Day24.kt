...
class Day24(test: Boolean) : PuzzleSolverAbstract(test, puzzleName="Never Tell Me The Odds", hasInputFile = true) {
...
// Thanks to: https://todd.ginsberg.com/post/advent-of-code/2023/Day24/ :
//
